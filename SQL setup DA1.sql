...
-- Evita que un mismo usuario reserve dos veces la misma clase (solo para reservas confirmadas)
-- Nota: Removemos el índice único ya que la validación se hace en el código
